<template>
  <div class="user-create-page">
    <app-tab-bar />
    <app-page-title title="Tạo mới tài khoản" />
    <div class="card mb-5 mb-xl-10" v-loading="isLoading">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12">
                <el-form-item label="Quyền" prop="authority">
                  <el-select class="w-full" v-model="userForm.authority">
                    <el-option
      ...
      <div class="card-footer d-flex justify-content-end py-4 px-8">
        ...
        <el-button :disabled="isLoading" type="primary" @click="submitForm('userForm')"
          >Lưu</el-button
        >
      </div>
    </div>
